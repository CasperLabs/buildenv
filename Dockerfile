...
# integration-testing/
RUN pip3 install docker delayed_assert pipenv pytest dataclasses typing_extensions dataclasses grpcio grpcio_tools protobuf in-place ed25519 pyblake2 lz4
